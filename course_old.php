...
echo "<div onclick=order_by_year('".$order_stat."',".$back_num.",".$u_no.")><a>學年度</a></div>";      #排序系列:點選之後依照學年度排序
echo "<div  onclick=order_by_nuk('".$order_stat."',".$back_num.",".$u_no.")><a>鈕扣數多-少</a></div>";
...
while($comment = mysqli_fetch_assoc($result_comment)){
    ...
    echo "</div>";
    echo "<tr><td>".$comment[content]."<br/></td>";
...
<button class="button3">我要寫評論 ✎</button></a></section>
</div>
